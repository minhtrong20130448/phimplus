...
const SeriesPage = () => {
  ...
  // Tổng số trang
  const totalPages = Math.ceil(seriesMovies.length / ITEMS_PER_PAGE);

  // Lấy danh sách phim theo trang hiện tại
  const currentMovies = seriesMovies.slice(
  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto p-4">
      <div className="text-white text-2xl font-bold mb-4">Phim bộ</div>
